...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_SLSH, KC_CIRC, KC_PERC, KC_DLR,  KC_LCBR, KC_RCBR, UMLAUT,  XXXXXXX, XXXXXXX, KC_BSLS, XXXXXXX,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),

/* Raise
 * ,-----------------------------------------------------------------------------------------------.
 * | TRNS  | bksps |   9   |   8   |   7   |       |       |       |       |       |       | TRNS  |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * | TRNS  |   0   |   3   |   2   |   1   | space |       |  ⌥ ←  |  ⌥ ↓  |  ⌥ ↑  |  ⌥ →  |       |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * | TRNS  |   ↲   |   6   |   5   |   4   |       |       |       |       |       |       |       |
...
[_RAISE] = LAYOUT_planck_grid(
    _______, KC_BSPC, KC_9,    KC_8,    KC_7,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   _______,
    _______, KC_0,    KC_3,    KC_2,    KC_1,    KC_SPC,  XXXXXXX, OP_LEFT, OP_DOWN, OP_UP,   OP_RGHT, XXXXXXX,
    _______, KC_ENT,  KC_6,    KC_5,    KC_4,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * | qwert |  F10  |  F1   |  F2   |  F3   |       |       |       |       | led   | brgh- | brgh+ |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * | colem |  ⇧⌘4  |  F4   |  F5   |  F6   |       |       |       |       | vol-  | mute  | vol+  |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
...
[_FN] = LAYOUT_planck_grid(
    ...
    T_COLEM, CMD_S_4, KC_F4,   KC_F5,   KC_F6,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU,
